...
Подробные правила находятся в отдельных файлах и не дублируются в `AGENTS.md`.

| Файл | Каноническое содержание |
|---|---|
| `operating-model.md` | Виды состояния и lifecycle результата |
| `autonomy-policy.md` | Полномочия агента и human gates |
